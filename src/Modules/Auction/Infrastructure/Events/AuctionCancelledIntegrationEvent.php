...
final class AuctionCancelledIntegrationEvent implements IntegrationEvent
{
    ...
    public static function fromDomainEvent(AuctionCancelled $event): self
    {
        return new self(
    ...
    {
        return 'auction.auction_cancelled';
    }
